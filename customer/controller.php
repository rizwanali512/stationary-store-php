...
function doInsert(){
	...
	function doDelete(){
		...
		//	$_SESSION['ORDEREDNUM'] = $_POST['ORDEREDNUM'];
			...
			$order->ORDEREDNUM		= $res->AUTO; 
			$order->USERID	= $_SESSION['CUSID'];
	     	$order->create(); 
 		  	$product = New Product();			 
		...
		message($_SESSION['ORDEREDNUM'] . "Order created successfully!", "success"); 		 
		redirect(web_root."index.php?q=profile");
