              ...
              <div class="form-group">
                  ...
                  <div class="radio" >
                      <label >
                        ...
                        <input class="hidden" id="CATEGORY" name="USERID" type="text" value="<?php echo $_SESSION['USERID']; ?>">
                        <input class="hidden" id="CATEGOwRY" name="CUSID" type="text" value="<?php echo $_SESSION['CUSID']; ?>">
